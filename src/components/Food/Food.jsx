...
const Food = (props) => {
    ...
    return (
        <div className='w-96 border-4 border-gray-500 p-5 rounded-lg text-center'>
            ...
            <button className='border-2 py-2 px-4 bg-green-600 font-bold text-white rounded-lg mt-4 hover:bg-purple-600'><Link to={`/food/${idMeal}`}>Show Details</Link></button>
        </div>
    );
};
